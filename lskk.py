...
FTP_FOLDER = os.getenv("FTP_FOLDER_LSKK", "/")
...
def callback(ch, method, properties, body):
    ...
    try:
        ...
        if saved_filename is None:
            ...
            return
        print("AI-"+guid_device)
        # Insert data ke MongoDB
        new_data = {
            "reporterName": "AI-"+guid_device,
            "guid": guid,
            "companyGuid":"COMPANY-0a3a303e-7dd0-4246-ad21-d675e77904b4-2024",
            "reportType": "AIProcessing-yolov8",
            "guidDevice": guid_device,
            "reportContent":"Deteksi objek menggunakan YOLOv8-" + guid_device,
            "imageUrl": "https://monja-file.pptik.id/v1/view?path=monitoring/"+saved_filename,
